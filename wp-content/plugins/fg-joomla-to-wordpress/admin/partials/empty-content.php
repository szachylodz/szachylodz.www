		<form id="form_empty_wordpress_content" method="post">
			...
			<table class="form-table">
				<tr>
					...
					<td><input type="radio" name="empty_action" id="empty_action_newposts" value="newposts" /> <label for="empty_action_newposts"><?php _e('Remove only new imported data', 'fg-joomla-to-wordpress'); ?></label><br />
